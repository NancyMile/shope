...
<template>
  <div class="md:w-1/2">
    ...
    <p class="text-lg m-t-5 text-center mb-10">
      Add patients <span class="text-indigo-600 font-bold">manage them</span>
    </p>
    ...
    >
      <div class="mb-5">
        <label class="block text-gray-600 uppercase font-bold" for="pet"
          >Pet Name</label
        >
        <input
          id="pet"
      ...
      <div class="mb-5">
        <label class="block text-gray-600 uppercase font-bold" for="owner"
          >Owner Name</label
        >
        <input
          id="owner"
      ...
      <div class="mb-5">
        <label class="block text-gray-600 uppercase font-bold" for="email"
          >Email</label
        >
        <input
          id="email"
